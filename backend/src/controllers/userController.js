  ...
  try {
    ...
    const token = jwt.sign(
        { 
            ...
            sobrenome: sobrenome || req.user.sobrenome,
            nome_social: nome_social !== undefined ? nome_social : req.user.nome_social,
            telefone: telefone !== undefined ? telefone : req.user.telefone,
...
exports.addOrUpdateAddress = async (req, res) => {
  try {
    ...
    const result = await Endereco.addOrUpdateByUserId(id_usuario, enderecoData);
...
exports.removeAddress = async (req, res) => {
  try {
    ...
    await Endereco.deleteByUserId(id_usuario);
...
exports.hasAddress = async (req, res) => {
  try {
    ...
    const hasAddress = await Endereco.hasAddressByUserId(id_usuario);
...
exports.uploadProfilePhoto = async (req, res) => {
  try {
    ...
    await Usuario.updateProfilePhoto(id_usuario, foto_url);
...
exports.toggleUserStatus = async (req, res) => {
  try {
    ...
    await Usuario.updateStatus(id, ativo);
...
exports.getUserActivity = async (req, res) => {
  try {
    ...
    const atividades = await Usuario.getActivityLog(id);
