const AdotaModel = require('../models/adotaModel');
...
module.exports = {
  // Métodos principais (mantendo nomes similares para compatibilidade)
  solicitarAdocao: AdotaController.solicitarAdocao.bind(AdotaController),
  listarMinhasAdocoes: AdotaController.listarMinhasAdocoes.bind(AdotaController),
  listarSolicitacoes: AdotaController.listarSolicitacoes.bind(AdotaController),
  buscarAdocao: AdotaController.buscarAdocao.bind(AdotaController),
  atualizarSolicitacao: AdotaController.atualizarAdocao.bind(AdotaController),
  cancelarAdocao: AdotaController.cancelarAdocao.bind(AdotaController),
  
  // Novos métodos
  aprovarAdocao: AdotaController.aprovarAdocao.bind(AdotaController),
  recusarAdocao: AdotaController.recusarAdocao.bind(AdotaController),
  buscarEstatisticas: AdotaController.buscarEstatisticas.bind(AdotaController),
  verificarAdocao: AdotaController.verificarAdocao.bind(AdotaController),
  
  // Classe para uso direto se necessário
  AdotaController
};